...
> The current desktop build is **Beta 1.0** (technical version `1.0.0-beta.1`). Repository: [github.com/pigking9527-cmyk/kunpeng-reader](https://github.com/pigking9527-cmyk/kunpeng-reader). Public binaries remain subject to license, IP, signing, and notarization gates.
