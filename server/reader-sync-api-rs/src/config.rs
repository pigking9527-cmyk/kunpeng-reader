...
impl Config {
    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            database_max_connections: parsed("KUNPENG_SYNC_DATABASE_MAX_CONNECTIONS", "16")?,
            max_concurrent_requests: parsed("KUNPENG_SYNC_MAX_CONCURRENT_REQUESTS", "64")?,
            max_concurrent_password_operations: parsed(
            ...
            body_limit_bytes: parsed("KUNPENG_SYNC_BODY_LIMIT_BYTES", "16777216")?,
...
fn smtp_config() -> Result<Option<SmtpConfig>> {
    ...
    Ok(Some(SmtpConfig {
        host,
        port: parsed("KUNPENG_SYNC_SMTP_PORT", "587")?,
