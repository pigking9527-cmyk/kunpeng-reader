...
> 当前桌面候选版本为 **测试版 1.1 修订版**（技术版本 `1.1.0-beta.3`）。项目地址：[github.com/pigking9527-cmyk/kunpeng-reader](https://github.com/pigking9527-cmyk/kunpeng-reader)。这是早期开发测试包；macOS 包使用临时签名、尚未公证。

测试版 1.1 修订候选的范围、旧包处置和安装包验收要求见 [修订版说明](docs/release/1.1.0-beta.3.md) 与 [桌面安装包验证要求](docs/release/desktop-artifact-verification.md)。
