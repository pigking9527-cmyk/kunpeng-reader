...
> 最新版本：**v1.9.3** · 下载见 [Releases](https://github.com/pigking9527-cmyk/kunpeng-reader/releases)（Windows 安装包 / 单文件绿色版；macOS Apple Silicon DMG / App ZIP）。
...
- **标签与收藏夹**：右键图书即可添加、移除和管理标签/收藏夹；漏斗面板支持多选过滤，分类会随图书轻数据同步
