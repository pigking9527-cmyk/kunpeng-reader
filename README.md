...
> 最新版本：**v1.6.0** · 下载见 [Releases](https://github.com/pigking9527-cmyk/kunpeng-reader/releases)（免安装绿色版，双击即用，Win10/11 自带 WebView2）。

## 特性

**阅读**
- **多格式**：EPUB / PDF / TXT / Markdown，批量导入、封面墙、拖拽导入、更换封面、**多目录自动导入**
