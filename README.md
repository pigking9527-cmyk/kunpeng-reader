...
> 最新版本：Windows、macOS、Linux **v1.16.0** · Android **v0.3.0**。下载见 [Releases](https://github.com/pigking9527-cmyk/kunpeng-reader/releases)。v1.16.0 重点完成桌面业务层的 React + TypeScript + Vite 迁移，并保留 Rust + Tauri 2 与独立阅读引擎的边界。
