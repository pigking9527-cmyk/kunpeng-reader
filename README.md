...
> 最新版本：**v1.8.7** · 下载见 [Releases](https://github.com/pigking9527-cmyk/kunpeng-reader/releases)（Windows 安装包 / 单文件绿色版，Win10/11 自带 WebView2）。
...
- **翻页体验**：整页模式支持单页/双页显示；滚动模式保持真实连续滚动，同时支持鼠标/键盘按虚拟页片段翻页；可选「纸张效果（Google）」翻页动画并调节动画速度
