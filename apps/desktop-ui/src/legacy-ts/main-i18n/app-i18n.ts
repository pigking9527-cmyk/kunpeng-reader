...
export function installAppI18n(
  ...
  const COPY: MutableCopy = {
    ...
    en: {
      ...
      semanticIndex: "Local smart-search library",
  ...
  const STARTUP_ENHANCEMENT_COPY = {
    "zh-CN": {
      ...
      startupEnhancementHighCostNote:
        "关闭高消耗任务后，语义索引、全文索引和 AI 图书标签等任务会在隐藏窗口时保存检查点并暂停，不会自动续建。",
    },
    "zh-TW": {
  ...
  Object.assign(localeCopy(COPY, "en"), {
    ...
    bookClassification: "AI book tags",
  ...
  const SETTINGS_LAYOUT_COPY = {
    en: {
      ...
      settingsManageIndex: "Open settings",
  ...
  const SEMANTIC_SETTINGS_COPY = {
    "zh-CN": {
      semTitle: "智能管理",
      semDescription:
        "统一管理智能搜索、回答与总结、阅读创作。搜索模型只在智能搜索区域切换；后台分析可以暂停和续建。",
      semSearchSolutions: "搜索方案",
      semSolutionLight: "轻量",
      semSolutionLightCopy: "0.6B 多语言语义理解，不启用结果精排",
      semSolutionStandard: "标准",
      semSolutionStandardCopy: "中英文混合，0.6B 语义理解＋0.6B 结果精排",
      semSolutionHigh: "高精度",
      semSolutionHighCopy: "8B 语义理解＋0.6B 结果精排（8B 精排待安装）",
      semSolutionM3: "BGE-M3 增强",
      semSolutionM3Copy: "多语言、关键词与语义混合检索",
      semSelectModel: "内容理解模型",
      ...
      semGpu: "运行设备",
      semDevicePolicy: "设备策略",
      semDeviceAuto: "自动选择",
      semDeviceGpu: "仅 GPU",
      semDeviceCpu: "仅 CPU",
      semGpuInitial: "点击“重新检测”读取当前模型的实际运行设备。",
      semActiveDevice: "当前模型实际运行于 {device}。",
      semGpuReady: "加速功能已就绪。",
      semRefreshGpu: "重新检测",
      semInstallGpuRuntime: "加载本机 CUDA 组件",
      semResumeGpuRuntime: "继续加载本机 CUDA 组件",
      semInstallingGpuRuntime: "正在加载本机 CUDA 组件…",
      semGpuInstallConfirm:
        "尚需下载并安装约 {size} GiB 的 NVIDIA GPU 运行库，是否继续？CPU 回退仍会保留。",
      semGpuDownloading: "正在扫描并加载本机 CUDA 12 与 cuDNN 9 组件…",
      semGpuInstallFailed: "本机 CUDA 组件加载失败：{error}",
      semIndexTitle: "智能搜索",
      semCurrentPlan: "当前方案：{plan}",
      semCustomSolution: "自定义",
      semCoverageBooks: "已分析：{done}/{total} 本",
      semPendingBooks: "待分析：{count} 本",
      semNotBuilt: "尚未分析",
      semBuildIndex: "分析本地内容",
      semUpdateLocalContent: "更新新增与变更",
      semRebuildAll: "重新分析全部",
      semResumeIndex: "继续分析本地内容",
      semClearSearchData: "清除搜索数据",
      semDeleteModel: "删除模型",
      semPause: "暂停",
      semAdvanced: "高级设置 · 结果精排与大型书库",
    ...
    en: {
      ...
      semSearchSolutions: "Search plan",
      semSolutionLight: "Light",
      semSolutionLightCopy: "0.6B multilingual embeddings without result refinement",
      semSolutionStandard: "Standard",
      semSolutionStandardCopy: "Mixed Chinese and English, 0.6B embeddings + 0.6B result refinement",
      semSolutionHigh: "High precision",
      semSolutionHighCopy: "8B embeddings + 0.6B result refinement (8B reranker not installed)",
      semSolutionM3: "BGE-M3 enhanced",
      semSolutionM3Copy: "Multilingual keyword and semantic hybrid retrieval",
      semSelectModel: "Content-understanding model",
      ...
      semGpu: "Running device",
      semDevicePolicy: "Device policy",
      semDeviceAuto: "Automatic",
      semDeviceGpu: "GPU only",
      semDeviceCpu: "CPU only",
      semActiveDevice: "The current model is actually running on {device}.",
      semGpuInitial: "Select Recheck to read the local GPU status.",
      semGpuReady: "Acceleration is ready.",
      semRefreshGpu: "Recheck",
      semInstallGpuRuntime: "Load local CUDA component",
      semResumeGpuRuntime: "Resume loading local CUDA component",
      semInstallingGpuRuntime: "Loading local CUDA component…",
      semGpuInstallConfirm:
        "Download and install about {size} GiB of remaining NVIDIA GPU runtime files? The CPU fallback remains available.",
      semGpuDownloading: "Scanning and loading local CUDA 12 and cuDNN 9 components…",
      semGpuInstallFailed: "Local CUDA component loading failed: {error}",
      semIndexTitle: "Smart search",
      semCurrentPlan: "Current plan: {plan}",
      semCustomSolution: "Custom",
      semCoverageBooks: "Analyzed: {done}/{total} books",
      semPendingBooks: "Pending: {count} books",
      semNotBuilt: "Not analyzed",
      semBuildIndex: "Analyze local content",
      semUpdateLocalContent: "Update new and changed content",
      semRebuildAll: "Reanalyze all",
      semResumeIndex: "Continue analyzing local content",
      semClearSearchData: "Clear search data",
      semDeleteModel: "Delete model",
      semPause: "Pause",
      semAdvanced: "Advanced settings · result refinement and large libraries",
      ...
      semM3Index: "BGE-M3 deep-retrieval data",
      semM3Description:
        "Balances keywords and meaning so complex questions are easier to find.",
      semBuildM3: "Build M3 index",
      semClearM3Data: "Clear deep-retrieval data",
      semAccelerator: "Large-library acceleration",
      semAcceleratorDescription:
        "Returns results faster for large libraries with a semantic index.",
      semBuildAccelerator: "Enable large-library acceleration",
      semClearAcceleratorData: "Clear acceleration data",
      ...
      semClearMultiData: "Clear profile data",
      semDelete: "Delete",
    },
    ja: {
      semTitle: "インテリジェント設定",
      ...
      semRefreshGpu: "再検出",
      semInstallGpuRuntime: "ローカル CUDA コンポーネントを読み込む",
      semResumeGpuRuntime:
        "ローカル CUDA コンポーネントの読み込みを再開",
      semInstallingGpuRuntime: "ローカル CUDA コンポーネントを読み込み中…",
      semGpuInstallConfirm:
        "残り約 {size} GiB の NVIDIA GPU ランタイムをダウンロードしてインストールしますか？CPUへのフォールバックは引き続き利用できます。",
      semGpuDownloading: "ローカル CUDA 12 / cuDNN 9 コンポーネントを検出して読み込み中…",
      semGpuInstallFailed:
        "ローカル CUDA コンポーネントの読み込みに失敗しました: {error}",
      semIndexTitle: "ローカルスマート検索ライブラリ",
      semNotBuilt: "未分析",
      semBuildIndex: "ローカル内容を分析",
      semPause: "一時停止",
      semAdvanced:
    ...
    ko: {
      ...
      semRefreshGpu: "다시 감지",
      semInstallGpuRuntime: "로컬 CUDA 구성 요소 불러오기",
      semResumeGpuRuntime: "로컬 CUDA 구성 요소 계속 불러오기",
      semInstallingGpuRuntime: "로컬 CUDA 구성 요소 불러오는 중…",
      semGpuInstallConfirm:
        "남은 NVIDIA GPU 런타임 약 {size} GiB를 다운로드하고 설치할까요? CPU 대체 경로는 계속 사용할 수 있습니다.",
      semGpuDownloading: "로컬 CUDA 12 및 cuDNN 9 구성 요소를 찾아 불러오는 중…",
      semGpuInstallFailed: "로컬 CUDA 구성 요소를 불러오지 못했습니다: {error}",
      semIndexTitle: "로컬 스마트 검색 라이브러리",
      semNotBuilt: "아직 분석되지 않음",
      semBuildIndex: "로컬 콘텐츠 분석",
      semPause: "일시 정지",
  ...
  const SEMANTIC_RUNTIME_COPY = {
    "zh-CN": {
      ...
      semQwen06Title: "Qwen3 Embedding 0.6B · 多语言标准",
      semQwen06Copy:
        "适合中英文混合内容，在模型体积、分析速度和语义精度之间保持平衡。",
      semQwen8Title: "Qwen3 Embedding 8B · 多语言高精度",
      semQwen8Copy:
        "以 8B 模型进行高精度语义理解，并配合已安装的 0.6B 结果精排模型。",
      semActualDownloadStatus: "以实际下载状态为准",
      semActiveDevice: "当前模型实际运行于 {device}。",
    ...
    en: {
      ...
      semQwen06Title: "Qwen3 Embedding 0.6B · Multilingual standard",
      semQwen06Copy:
        "Balances model size, analysis speed, and semantic precision for mixed Chinese and English content.",
      semQwen8Title: "Qwen3 Embedding 8B · High-precision multilingual",
      semQwen8Copy:
        "Uses an 8B embedding model with the installed 0.6B result-refinement model.",
      semActualDownloadStatus: "shown by actual download status",
      semActiveDevice: "The current model is actually running on {device}.",
      semRetrievalStandardCopy:
      ...
      semResumeIndex: "Continue analyzing local content",
      semUpdateAccelerator: "Update large-library acceleration",
      semBuildMulti: "Build multi-profile index",
    },
    ja: {
